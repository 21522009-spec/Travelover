...
public class OwnerConversationsAdapter
        extends RecyclerView.Adapter<OwnerConversationsAdapter.ConversationViewHolder> {

    public interface OnConversationClickListener {
        void onConversationClick(@NonNull OwnerConversation conversation);
    }

    private final List<OwnerConversation> conversations = new ArrayList<>();
    private final OnConversationClickListener listener;

    public OwnerConversationsAdapter(@NonNull OnConversationClickListener listener) {
        this.listener = listener;
    }

    public void submitList(@NonNull List<OwnerConversation> data) {
        conversations.clear();
    ...
    public ConversationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_owner_conversation, parent, false);
    ...
    static class ConversationViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(@NonNull OwnerConversation conversation,
